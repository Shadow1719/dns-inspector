...
# Keep the /api/observability decorator attached to api_observability().
# The diagnostic helpers must be inserted after the endpoint function, not
# between its Flask decorator and definition.
...
def _memory_diagnostics():
    ...
    try:
        result['gc_object_count'] = len(gc.get_objects())
    except Exception:
