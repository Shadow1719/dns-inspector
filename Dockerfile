...
COPY build_perf_patch.py build_perf_hardcap.py build_memory_patch.py build_device_labels_patch_v2.py build_enrichment_retry_patch.py build_ui_followup_patch.py build_device_ip_retention_patch.py build_ip_ping_patch.py /app/
